...
// Define plugin paths
define('SCROLLBAR_WP_PLUGIN_PATH', plugin_dir_url(__FILE__));
...
function tp_scrollbars_load_textdomain(){
	load_plugin_textdomain('scrollbar', false, dirname( plugin_basename( __FILE__ ) ) .'/languages/' );
}
...
function scrollbar_wp_menu_init() {
	if ( current_user_can( 'manage_options' ) ) {
		add_menu_page(__('Scrollbar Wp','scrollbar'), __('WP Scrollbar','scrollbar'), 'manage_options', 'scrollbar_wp_admin_page', 'scrollbar_wp_admin_page');
	}
}
